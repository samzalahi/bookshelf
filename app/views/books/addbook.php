        ...
        <?php echo flash('flash_message'); ?>
            <div class="col-md-12">
                <div class="card card-body bg-light mt-4 position-relative">
                    ...
                    <form id="addbook" action="<?php echo URLROOT;?>/books/add" method="post" enctype="multipart/form-data" class="d-flex">
                        <div class="col-sm-5 mr-3 form-left">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="author" autocomplete="off" class="col-sm-12 form-control
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="edition" autocomplete="off" class="col-sm-12 form-control
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="no_of_books" autocomplete="off" class="col-sm-12 form-control
                        ...
                        <div class="col-sm-5 ml-3 form-right">
                            <div class="form-group">
                                ...
                                <input type="text" name="book_no" autocomplete="off" class="col-sm-12 form-control
                        ...
                        <div class="addbook">
                            <button name="addbook" class="btn btn-success btn-block"><i class="fas fa-cloud-upload-alt"></i> Add Book</button>
                        </div>                       
                    </form>
                </div>
            </div>

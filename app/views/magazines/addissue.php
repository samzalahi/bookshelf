        ...
        <div class="col-md-12">
            <div class="card card-body bg-light mt-5">
                <div class="row col-md-12">
                    <h1 class="">Add <?php echo $data['title'] ?> Issue</h1>
                    <!-- <div class="align-self-center ml-auto">
                        <button onclick="goBack()" class="btn btn-success"><i class="fas fa-backward"></i> Go back</button>
                    </div> -->
                </div>
                <form action="<?php echo URLROOT;?>/magazines/addissue/<?php echo $data['id']; ?>" enctype="multipart/form-data" method="post" class="d-flex">
                    <div class="col-sm-5 mr-3 form-left">
                        <div class="form-group">
                            <label for="title" class="col-form-label">Title:<sup>*</sup></label>
                            <input type="text" readonly name="title" autocomplete="off" class="col-sm-12 form-control
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="date" data-provide="datepicker" autocomplete="off" class="col-sm-12 form-control
                    ...
                    <div class="col-sm-5 ml-3 form-right">
                        ...
                        <div class="form-group">
                                ...
                                <textarea name="description" class="col-sm-12 form-control" placeholder="Enter description" rows="3"><?php echo $data['description']?></textarea>
                            </div>
                        <div class="form-group">
                    ...
                    <div class="addbook">
                        <button type="submit" name="addbook" class="btn btn-success btn-block"><i class="fas fa-cloud-upload-alt"></i> Add Issue</button>
                    </div>    
                </form>
             </div>
        </div>
